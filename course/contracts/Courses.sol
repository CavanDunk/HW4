...
contract Courses {
  ...
  function setInstructor(address _address, uint _age, string memory _fName, string memory _lName) public payable {
    //instructorAccts.push(Instructor(_age, _fName, _lName)) - 1;
